                                ...
                                <li class="footer-col-block">
                                    ...
                                    <div class="tf-collapse-content">
                                        <ul class="ft-menu-list">
                                            ...
                                            <li><a href="shop-default.html" class="link">Cameras & Photography</a>
                                            </li>
                                            <li><a href="shop-default.html" class="link">Smart Phones & Tablets</a>
                                            </li>
                                            <li><a href="shop-default.html" class="link">Video Games & Consoles</a>
                                            </li>
                                            <li><a href="shop-default.html" class="link">TV & Audio</a></li>
                                            <li><a href="shop-default.html" class="link">Gadgets</a></li>
                                            <li><a href="shop-default.html" class="link">Waterproof Headphones</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="footer-col-block">
                                    ...
                                    <div class="tf-collapse-content">
                                        <ul class="ft-menu-list">
                                            ...
                                            <li><a href="contact.html" class="link">Product Support</a></li>
                                        </ul>
                                    </div>
                                </li>
                        ...
                        <div class="ft-center justify-content-xxl-between">
                            <p class="notice text-white justify-content-xxl-between">
                                <span class="main-title fw-semibold ">
                                    <img src="{{ asset('clients/images/mail.svg') }}" alt="">
                            ...
                            <form action="#" class="form-newsletter" method="post" accept-charset="utf-8"
                                ...
                                <div class="subscribe-content">
                                    <fieldset class="email">
                                        <input type="email" name="email-form" class="subscribe-email type-fs-2"
                                            placeholder="Enter your email address" tabindex="0"
                    ...
                    <div class="container">
                        <div class="ft-bottom">
                            ...
                            <ul class="ft-menu-list-2 body-text-3">
                                ...
                                <li><a href="blog-grid.html" class="title-sidebar link fw-bold">Top 100 offers</a>
                                </li>
