                                ...
                                <nav class="main-nav-menu">
                                    <ul class="nav-list">
                                        <li class="nav-item active pst-unset">
                                            <a href="javascript:void(0)" class="item-link link body-md-2 fw-semibold">
                                                <span>Home</span>
                                                <i class="icon icon-arrow-down"></i>
                                            </a>
                                            <div class="sub-menu-container mega-menu mega-home">
                                                <div class="container">
                                                    <ul class="row-demo">
                                                        <li class="demo-item active">
                                                            <a href="index-2.html">
                                                                <div class="demo-image relative">
                                                                    <img src="{{ asset('clients/images/demo/home-1.jpg') }}"
                                                                        data-src="{{ asset('clients/images/demo/home-1.jpg') }}"
                                                                        alt="" class="lazyload">
                                                                ...
                                                                <span class="demo-name">Home 1</span>
                                                            </a>
                                                        </li>
                                                        <li class="demo-item">
                                                            <a href="home-2.html">
                                                                <div class="demo-image relative">
                                                                    <img src="{{ asset('clients/images/demo/home-2.jpg') }}"
                                                                        data-src="{{ asset('clients/images/demo/home-2.jpg') }}"
                                                                        alt="" class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span class="demo-hot">New</span>
                                                                    </div>
                                                                </div>
                                                                <span class="demo-name">Home 2</span>
                                                            </a>
                                                        </li>
                                                        <li class="demo-item">
                                                            <a href="home-3.html">
                                                                <div class="demo-image relative">
                                                                    <img src="{{ asset('clients/images/demo/home-3.jpg') }}"
                                                                        data-src="{{ asset('clients/images/demo/home-3.jpg') }}"
                                                                        alt="" class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                    </div>
                                                                </div>
                                                                <span class="demo-name">Home 3</span>
                                                            </a>
                                                        </li>
                                                        <li class="demo-item">
                                                            <a href="home-4.html">
                                                                <div class="demo-image relative">
                                                                    <img src="{{ asset('clients/images/demo/home-4.jpg') }}"
                                                                        data-src="{{ asset('clients/images/demo/home-4.jpg') }}"
                                                                        alt="" class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                    </div>
                                                                </div>
                                                                <span class="demo-name">Home 4</span>
                                                            </a>
                                                        </li>
                                                        <li class="demo-item">
                                                            <a href="home-5.html">
                                                                <div class="demo-image relative">
                                                                    <img src="{{ asset('clients/images/demo/home-5.jpg') }}"
                                                                        data-src="{{ asset('clients/images/demo/home-5.jpg') }}"
                                                                        alt="" class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span>Trend</span>
                                                                ...
                                                                <span class="demo-name">Home 5</span>
                                                            </a>
                                                        </li>
                                                        <li class="demo-item">
                                                            <a href="home-6.html">
                                                                <div class="demo-image relative">
                                                                    <img src="{{ asset('clients/images/demo/home-6.jpg') }}"
                                                                        data-src="{{ asset('clients/images/demo/home-6.jpg') }}"
                                                                        alt="" class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span>Trend</span>
                                                                ...
                                                                <span class="demo-name">Home 6</span>
                                                            </a>
                                                        </li>
                                                        <li class="demo-item">
                                                            <a href="home-7.html">
                                                                <div class="demo-image relative">
                                                                    <img src="{{ asset('clients/images/demo/home-7.jpg') }}"
                                                                        data-src="{{ asset('clients/images/demo/home-7.jpg') }}"
                                                                        alt="" class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                ...
                                                                <span class="demo-name">Home 7</span>
                                                            </a>
                                                        </li>
                                                        <li class="demo-item">
                                                            <a href="home-8.html">
                                                                <div class="demo-image relative">
                                                                    <img src="{{ asset('clients/images/demo/home-8.jpg') }}"
                                                                        data-src="{{ asset('clients/images/demo/home-8.jpg') }}"
                                                                        alt="" class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span class="demo-hot">Hot</span>
                                                                ...
                                                                <span class="demo-name">Home 8</span>
                                                            </a>
                                                        </li>
                                                        <li class="demo-item">
                                                            <a href="home-9.html">
                                                                <div class="demo-image relative">
                                                                    <img src="{{ asset('clients/images/demo/home-9.jpg') }}"
                                                                        data-src="{{ asset('clients/images/demo/home-9.jpg') }}"
                                                                        alt="" class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span class="demo-hot">Hot</span>
                                                                ...
                                                                <span class="demo-name">Home 9</span>
                                                            </a>
                                                        </li>
                                                        <li class="demo-item">
                                                            <a href="home-10.html">
                                                                <div class="demo-image relative">
                                                                    <img src="{{ asset('clients/images/demo/home-10.jpg') }}"
                                                                        data-src="{{ asset('clients/images/demo/home-10.jpg') }}"
                                                                        alt="" class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span class="demo-hot">Hot</span>
                                                                ...
                                                                <span class="demo-name">Home 10</span>
                                                            </a>
                                                        </li>
                                                        <li class="demo-item">
                                                            <a href="home-11.html">
                                                                <div class="demo-image relative">
                                                                    <img src="{{ asset('clients/images/demo/home-11.jpg') }}"
                                                                        data-src="{{ asset('clients/images/demo/home-11.jpg') }}"
                                                                        alt="" class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span class="demo-hot">Hot</span>
                                                                ...
                                                                <span class="demo-name">Home 11</span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                            ...
                                            <div class="sub-menu-container mega-menu text-nowrap">
                                                <div class="wrapper-sub-menu">
                                                    <div class="mega-menu-item">
                                                        <p class="menu-heading body-small">SHOP LAYOUT</p>
                                                        <ul class="menu-list">
                                                            <li>
                                                                <a href="shop-default.html" class="body-md-2 link">
                                                                    <span>Shop Default</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="shop-right-sidebar.html"
                                                                    class="body-md-2 link">
                                                                    <span>Shop Right Sidebar</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="shop-fullwidth.html" class="body-md-2 link">
                                                                    <span>Shop Full Width</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="shop-cart.html" class="body-md-2 link">
                                                                    <span>Shop Cart</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div class="mega-menu-item">
                                                        <p class="menu-heading body-small">WOO PAGE</p>
                                                        <ul class="menu-list">
                                                            <li>
                                                                <a href="compare.html" class="body-md-2 link">
                                                                    <span>Compare</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="wishlist.html" class="body-md-2 link">
                                                                    <span>Wishlist</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="checkout.html" class="body-md-2 link">
                                                                    <span>Check Out</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="order-details.html" class="body-md-2 link">
                                                            ...
                                                            <li>
                                                                <a href="my-account.html" class="body-md-2 link">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="sub-menu-container mega-menu text-nowrap">
                                                <div class="wrapper-sub-menu">
                                                    <div class="mega-menu-item">
                                                        <p class="menu-heading body-small">PRODUCT LAYOUTS</p>
                                                        <ul class="menu-list">
                                                            <li>
                                                    ...
                                                    <div class="mega-menu-item">
                                                        <p class="menu-heading body-small">PRODUCT DETAILS</p>
                                                        <ul class="menu-list">
                                                            <li>
